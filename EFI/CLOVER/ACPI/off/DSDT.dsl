 ...
 *
 * Disassembly of DSDT.aml, Wed Jun 24 20:22:49 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00018429 (99369)
 *     Revision         0x02
 *     Checksum         0x5E
 *     OEM ID           "_ASUS_"
...
{
    /*
     * iASL Warning: There were 37 external control methods found during
     * disassembly, but only 26 were resolved (11 unresolved). Additional
    ...
    External (_SB_.PCI0.IGPU.ADVD, IntObj)
    ...
    External (_SB_.PCI0.IGPU.DD02._BCM, MethodObj)    // 1 Arguments    // From external reference file
    External (_SB_.PCI0.IGPU.DWBL, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.IGPU.GCBL, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.IGPU.GCDS, IntObj)
    ...
    External (_SB_.PCI0.SATA.SDSM, MethodObj)    // 4 Arguments    // From external reference file
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xAD7B7000, 0x0359)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
                ...
                Device (PXSX)
                {
                    ...
                    Method (_DSM, 4, NotSerialized)
                    {
                        ...
                        Return (Package()
                        {
                            ...
                            "model", Buffer() { "Atheros 9485 802.11 b/g/n Wireless Network Adapter" },
                            "subsystem-id", Buffer() { 0x44, 0xE0, 0x00, 0x00 },
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xACAB0F18, 0x10)
...
RWAK (Arg0)
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (ACD0)
        {
            ...
            Name (_SUB, "0x241A1043")  // _SUB: Subsystem ID
            ...
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                If (LEqual (CODS, Zero))
                {
                    Store (Zero, MCLK) /* \_SB_.PCI0.I2C1.ACD0.MCLK */
                }
                ElseIf (LEqual (CODS, One))
                {
                    Store (0x18, MCLK) /* \_SB_.PCI0.I2C1.ACD0.MCLK */
                }

                Store (0x09, SCLK) /* \_SB_.PCI0.I2C1.ACD0.SCLK */
                Store (Zero, SSPM) /* \_SB_.PCI0.I2C1.ACD0.SSPM */
            }
            ...
            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                Store (One, EOD) /* \_SB_.PCI0.I2C1.ACD0.EOD_ */
            }
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                ...
                If (And (EOD, One, EOD) /* \_SB_.PCI0.I2C1.ACD0.EOD_ */)
                {
                    Return (0x0F)
                }
                Else
            ...
            {
                Store (Zero, EOD) /* \_SB_.PCI0.I2C1.ACD0.EOD_ */
            }
        }
    ...
    External(_SB.PCI0.RP05.PXSX._DEP, MethodObj)
...
, 
    ...
    Scope (\)
    {
        ...
        Method (ADVG, 0, NotSerialized)
        {
            ...
            {
                Return (\_SB.PCI0.IGPU.ADVD) /* External reference */
            }
        ...
        Method (GCDM, 0, NotSerialized)
        {
            If (\_SB.PCI0.IGPU.PRST ())
            {
                Return (\_SB.PCI0.IGPU.GCDS) /* External reference */
            }
            ...
            Name (BUF0, ResourceTemplate()
{
    ...
    OperationRegion (ABNV, SystemMemory, 0xAD7A6000, 0x000D)
            ...
            If (LEqual (Arg0, ToUUID ("3dddfaa6-361b-4eb4-a424-8d10089d1653") /* Physical Presence Interface */))
            {
                Switch (ToInteger (Arg2))
                {
                    ...
                    Case (0x03)
                    {
                        ...
                        Return (PPI1) /* \_SB_.TPM_.XDSM.PPI1 */
                    }
                    Case (0x04)
                    {
                        Return (TRST) /* \TRST */
                    ...
                    Case (0x05)
                    {
                        ...
                        If (LEqual (DAT, 0xF0))
                        {
                            ...
                            If (LEqual (DAT, 0xFF))
                            {
                                ...
                                Return (PPI2) /* \_SB_.TPM_.XDSM.PPI2 */
                            }
                        }
